...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep 13 10:10:25 2018
...
#print Parallel coordinates graph of rocks versus mines attributes
for i in range(208):
...
dataRow2 = rocksVMines.iloc[:,1]
dataRow3 = rocksVMines.iloc[:,2]
plot.scatter(dataRow2, dataRow3)
plot.xlabel("2nd Attribute")
plot.ylabel(("3rd Attribute"))
plot.show()
dataRow21 = rocksVMines.iloc[:,20]
